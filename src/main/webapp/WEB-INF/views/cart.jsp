...
<title><spring:message code="cart.list.windowTitle"/></title>
</head>
<body>
	<section>
		<div class="jumbotron">
			<div class="container">
				<h1><spring:message code="cart.list.header"/></h1>
				<p><spring:message code="cart.list.subHeader"/></p>
			</div>
		</div>
	</section>
	...
	<section class="container" ng-app="cartApp">
		<div ng-controller="cartCtrl" ng-init="initCartId('${cartId}')">
			...
			<a href="<spring:url value="/products" />" class="btn btn-default">
				<span class="glyphicon-hand-left glyphicon"></span> <spring:message code="cart.list.continueShopping.label"/>
			</a>
		</div>
	</section>
</body>
